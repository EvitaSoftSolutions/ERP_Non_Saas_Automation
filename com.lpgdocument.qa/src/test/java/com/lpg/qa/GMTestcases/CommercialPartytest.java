...
public class CommercialPartytest {
	...
	public class EmployeeTest  extends LpgTestBase{
		...
		//	TestBase.driver.close();
			...
			@Test
			public void CommercialPartytest() throws InterruptedException {
				 ...
				 */
				co.setup(driver);
				//co.VerifyandClickonMyerpLoginBtn();
				...
				co.VerifyMyerpConsumerNumber();
				co.VerifyMyerpCPBusinessname();
				co.VerifyMyerpCPSelectBusinessType();
				co.VerifyMyerpCPSelectGroup();
				co.VerifyMyerpCPAddress1();
				co.VerifyMyerpCPSelectState();
				co.VerifyMyerpbillingtype1();
				co.VerifyMyerpCPActivechk();
				co.VerifyMyerpCPProduct();
				co.VerifyMyerpCPPQantity();
				...
				co.VerifyMyerpCPEditBtn();
				co.VerifyMyerpCPYesUpdateBtn();
				co.VerifyMyerpCPUpdateBtn();
				co.VerifyMyerpCPUpdateokBtn();

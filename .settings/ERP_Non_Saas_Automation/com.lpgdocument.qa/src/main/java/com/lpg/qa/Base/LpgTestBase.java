      ...
      public static  WebDriver driver;
			...
			public WebDriver intializeBrowser(String browser) {
		     ...
		     System.setProperty("webdriver.chrome.driver", "C:\\Users\\dell\\Downloads\\chromedriver (1).exe");
				...
				driver.findElement(By.xpath("//input[@id='txtEmail']")).sendKeys("pankaj");
				driver.findElement(By.xpath("//input[@id='password-field']")).sendKeys("pankaj@123");
			...
			public void screenshotCapture(ITestResult result) throws IOException, InterruptedException {
				if(result.getStatus()==ITestResult.FAILURE) {
					...
					FileUtils.copyFile(source, new File("C:\\Users\\dell\\Desktop\\screen shot\\LPG"+name));
				}

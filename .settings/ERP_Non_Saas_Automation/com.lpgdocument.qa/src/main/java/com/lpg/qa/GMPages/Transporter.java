...
public class Transporter {
	...
	@FindBy(xpath="//input[@id='txtTransporterAliasName']")private WebElement talisename;
	...
	@FindBy(xpath="//select[@id='ddlstate']")private WebElement tstate;
	...
	public void VerifyMyerpTName() throws InterruptedException {
		...
		tname.click();
		tname.clear();
		tname.sendKeys("ANITA GAS SERVICE");
	}
	public void VerifyMyerpTalisename() throws InterruptedException {
		Thread.sleep(500);
		Assert.assertTrue(talisename.isEnabled(),"talisename field is enabled");		 
		Reporter.log("verifyMyerptalisename", true);
		talisename.click();
		talisename.clear();
		talisename.sendKeys("ANITA GAS SERVICE");
	}
	...
	public void VerifyMyerpTState() throws InterruptedException {
		Select sc = new Select(tstate);
		Thread.sleep(1000);
		Assert.assertTrue(tstate.isDisplayed(),"tstate is displayed");
		Assert.assertFalse(tstate.isSelected());
		tstate.clear();
	...
	public void VerifyMyerpTalisename1() throws InterruptedException {
		Thread.sleep(500);
		Assert.assertTrue(talisename.isEnabled(),"talisename field is enabled");		 
		Reporter.log("verifyMyerptalisename", true);
		talisename.click();
	...
	public void VerifyMyerpTState1() throws InterruptedException {
		Select sc = new Select(tstate);
		Thread.sleep(1000);
		Assert.assertTrue(tstate.isDisplayed(),"tstate is displayed");
		Assert.assertFalse(tstate.isSelected());
	...
	public void VerifyandClickonPSearchbar1() throws InterruptedException {
		...
		pcsearchbar.click(); 
		pcsearchbar.clear();
		pcsearchbar.sendKeys("ANITA GAS SERVICE");
		Thread.sleep(500);
	}

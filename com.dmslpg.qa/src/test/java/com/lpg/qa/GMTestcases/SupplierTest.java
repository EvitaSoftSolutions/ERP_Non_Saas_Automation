...
public class SupplierTest  extends LpgTestBase{
	...
	public void SupplierPageTest() throws InterruptedException {
		...
		/*
		 * s.verifyMyerpagancycode(); s.verifyMyerpUserid(); s.verifyMyerpPassword();
		...
		s.VerifyMyerpSupplierClearBtn(); s.SelectCompany1();
		s.VerifyMyerpSsupcompanyCode1(); s.VerifyMyerpSupplierName1();
		s.SelectGroup1(); s.VerifyMyerpSupplierContandDetial1();
		s.VerifyMyerpSupplierAddress11(); s.SelectState1();

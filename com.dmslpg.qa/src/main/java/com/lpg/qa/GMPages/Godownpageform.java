	 ...
	 public void setup(WebDriver driver) 
	 {
		...
		//usage
			...
			public void VerifyandClickonPSearchbar1() throws InterruptedException {
		    	  ...
		    	  pcsearchbar.click(); 
		    	  pcsearchbar.clear();
		    	  pcsearchbar.sendKeys("VIRAR East");
			...
			public void VerifyandClickonPSearchbar11() throws InterruptedException {
		    	  Thread.sleep(500);
		    	  Assert.assertTrue(pcsearchbar.isEnabled()," pcsearchbar field is enabled");
		    	  Reporter.log(" verifyMyerp pcsearchbar", true);
		    	  pcsearchbar.click(); 
			...
			public void verifyMyerpGodownName2() throws InterruptedException {
				Thread.sleep(1000);
				Assert.assertTrue(godownname.isEnabled(),"GodownName is Enable");
				Reporter.log("verifyMyerpgodownname",true);
				godownname.sendKeys("VIRAR WEST");
			}
			public void verifyMyerpGodownAddress2() throws InterruptedException {
				Thread.sleep(500);
				Assert.assertTrue(godownaddress.isEnabled(),"GodownAddress is Enable");
				Reporter.log("verifyMyerpgodownaddress",true);
				godownaddress.sendKeys("VIRAR West");
			}
			public void verifyMyerpCheckActive2()throws InterruptedException {
				Thread.sleep(500);
				Assert.assertTrue(chekactive.isEnabled(),"CheckActive is Enable");
				Reporter.log("verifyMyerpchekactive",true);
				chekactive.click();
			...
			public void verifyMyerpEditbutton2() throws InterruptedException {
				Thread.sleep(500);
				Assert.assertTrue(editbtn.isEnabled(),"Editbutton is Enable");
				Reporter.log("verifyMyerpeditbtn",true);
				editbtn.click();
			...
			public void verifyMyerpConfirmbutton2() throws InterruptedException {
				Thread.sleep(500);
				Assert.assertTrue(confirmbtn.isEnabled(),"Confirmbutton is Enable");
				Reporter.log("verifyMyerpconfirmbtn",true);
				confirmbtn.click();
			...
			public void verifyMyerpGodownName22() throws InterruptedException {
				Thread.sleep(500);
				Assert.assertTrue(godownname.isEnabled(),"GodownName is Enable");
				Reporter.log("verifyMyerpgodownname",true);
				godownname.click();
			...
			public void verifyMyerpGodownAddress22() throws InterruptedException {
				Thread.sleep(500);
				Assert.assertTrue(godownaddress.isEnabled(),"GodownAddress is Enable");
				Reporter.log("verifyMyerpgodownaddress",true);
				godownaddress.click();
			...
			public void verifyMyerpUpdatebtn2() throws InterruptedException {
				Thread.sleep(500);
				Assert.assertTrue(updatebtn.isEnabled(),"updatebtn is Enable");
				Reporter.log("verifyMyerpupdatebtn",true);
				updatebtn.click();
			...
			public void verifyMyerpupdateokbtn2() throws InterruptedException{
				Thread.sleep(800);
				Assert.assertTrue(updateokbtn.isEnabled(),"updateokbtn is Enable");
				Reporter.log("verifyMyerpupdateokbtn",true);
				updateokbtn.click();
			...
			public void verifyMyerpexportbtn2() throws InterruptedException{
				Thread.sleep(800);
				Assert.assertTrue(exportbtn.isEnabled(),"exportbtn is Enable");
				Reporter.log("verifyMyerpexportbtn",true);
				exportbtn.click();
			...
			public void VerifyandClickonPSearchbar22() throws InterruptedException {
		    	  Thread.sleep(500);
		    	  Assert.assertTrue(pcsearchbar.isEnabled()," pcsearchbar field is enabled");
		    	  Reporter.log(" verifyMyerp pcsearchbar", true);
		    	  pcsearchbar.click(); 

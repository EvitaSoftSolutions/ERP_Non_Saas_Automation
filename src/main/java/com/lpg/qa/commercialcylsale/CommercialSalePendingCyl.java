...
import org.testng.Assert;
	...
	public class CommercialSalePendingCyl {
			@FindBy (xpath="//input[@id='txtAgencyCode']") private WebElement agancycode ;
			@FindBy (xpath="//input[@id='txtEmail']") private WebElement userid;
			@FindBy (xpath="//input[@id='password-field']") private WebElement password;
			@FindBy (xpath="//button[@id='btnLogin']") private WebElement login;
			@FindBy (xpath="//*[@id=\"menuReports\"]/a/span[1]") private WebElement genralreport; 
			@FindBy (xpath="//*[@id=\"menuReports\"]/ul/li[13]/a") private WebElement commercialsalependingreg;
			...
			// initialization
			public CommercialSalePendingCyl(WebDriver driver) {
				...
				public void VerifyMyerpCommercialCylSalePendingRegister() {
					 Assert.assertTrue(commercialsalependingreg.isEnabled(),"commercialsalependingreg field is enabled");		 
					 Reporter.log("verifyMyerpcommercialsalependingreg", true);
					 commercialsalependingreg.click(); 
				}
				...
				public void verifyMyerpSelectParty() throws InterruptedException {
					...
					su.selectByVisibleText("KRISHNA HOTEL");

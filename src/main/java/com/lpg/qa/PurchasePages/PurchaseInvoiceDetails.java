...
public class PurchaseInvoiceDetails {
			...
			@FindBy (xpath="//*[@id=\"menuReports\"]/ul/li[6]/a") private WebElement purchaseinvoicedetails;
			@FindBy(xpath="//select[@id='ddlCompanyCode']")private WebElement selectcomp;
			@FindBy (xpath="//input[@id='txtPurchaseInvoiceNo']") private WebElement purchasebillno;
			@FindBy (xpath="//button[@id='btnGetdata']") private WebElement getdatabtn; 
			
			
			
			// initialization
						public PurchaseInvoiceDetails(WebDriver driver) {
							...
							public void VerifyandClickonMyerpPurchaseInvoiceDetails() {
								 Assert.assertTrue(purchaseinvoicedetails.isEnabled(),"purchaseinvoicedetails is enabled");
								 Reporter.log(" verifyMyerppurchaseinvoicedetails", true);
								 purchaseinvoicedetails.click();
							}
							...
							public void VerifyandClickonMyerpPurchaseBillNumber() {
								 Assert.assertTrue(purchasebillno.isEnabled(),"purchasebillno is enabled");
								 Reporter.log(" verifyMyerppurchasebillno", true);
								 purchasebillno.click();
								 purchasebillno.sendKeys("2200030");

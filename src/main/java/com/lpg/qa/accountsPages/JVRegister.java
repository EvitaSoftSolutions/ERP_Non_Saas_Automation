...
public class JVRegister  {
			...
			@FindBy (xpath="//*[@id=\"tblGeneralMasters\"]/tbody/tr[5]/td[2]/a") private WebElement jvregister;
			...
			// initialization
			public JVRegister(WebDriver driver) {
				...
				public void VerifyandClickonMyerpJVRegisterReport() throws InterruptedException {
					Thread.sleep(600);
					 Assert.assertTrue(jvregister.isEnabled(),"jvregister is enabled");
					 Reporter.log("verifyMyerpjvregister", true);
					 jvregister.click();

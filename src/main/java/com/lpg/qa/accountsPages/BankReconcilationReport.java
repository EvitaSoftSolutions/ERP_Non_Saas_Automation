...
public class BankReconcilationReport {
			...
			@FindBy (xpath="//*[@id=\"tblGeneralMasters\"]/tbody/tr[5]/td[2]/a") private WebElement bankreconsilationregister;
			...
			// initialization
			public BankReconcilationReport(WebDriver driver) {
				...
				public void VerifyandClickonMyerpBankReconcilationReport() throws InterruptedException {
					Thread.sleep(600);
					 Assert.assertTrue(bankreconsilationregister.isEnabled(),"bankreconsilationregister is enabled");
					 Reporter.log("verifyMyerpbankreconsilationregister", true);
					 bankreconsilationregister.click();

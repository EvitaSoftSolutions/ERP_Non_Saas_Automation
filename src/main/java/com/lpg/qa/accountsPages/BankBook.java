...
public class BankBook {
			...
			@FindBy (xpath="//*[@id=\"tblGeneralMasters\"]/tbody/tr[4]/td[2]/a") private WebElement bankbookregister;
			...
			// initialization
			public BankBook(WebDriver driver) {
				...
				public void VerifyandClickonMyerpBankBookReport() throws InterruptedException {
					Thread.sleep(600);
					 Assert.assertTrue(bankbookregister.isEnabled(),"bankbookregister is enabled");
					 Reporter.log("verifyMyerpbankbookregister", true);
					 bankbookregister.click();

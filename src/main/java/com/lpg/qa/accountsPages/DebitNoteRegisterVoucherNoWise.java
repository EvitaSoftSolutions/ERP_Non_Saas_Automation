...
public class DebitNoteRegisterVoucherNoWise{
			...
			@FindBy (xpath="//*[@id=\"tblGeneralMasters\"]/tbody/tr[10]/td[2]/a") private WebElement debitnotenowisereport;
			...
			// initialization
			public DebitNoteRegisterVoucherNoWise(WebDriver driver) {

...
public class ContraRegister   {
			...
			@FindBy (xpath="//*[@id=\"tblGeneralMasters\"]/tbody/tr[7]/td[2]/a") private WebElement contraregister;
			...
			// initialization
			public ContraRegister(WebDriver driver) {
				...
				public void VerifyandClickonMyerpContraRegisterReport() throws InterruptedException {
					Thread.sleep(600);
					 Assert.assertTrue(contraregister.isEnabled(),"contraregister is enabled");
					 Reporter.log("verifyMyerpcontraregister", true);
					 contraregister.click();

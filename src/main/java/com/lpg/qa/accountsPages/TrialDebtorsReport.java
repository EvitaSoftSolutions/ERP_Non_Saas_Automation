...
public class TrialDebtorsReport {
			...
			@FindBy (xpath="//*[@id=\"tblGeneralMasters\"]/tbody/tr[9]/td[2]/a") private WebElement traildebtorsreport;
			...
			// initialization
			public TrialDebtorsReport(WebDriver driver) {
				...
				public void VerifyandClickonMyerpTrialBalanceStraightReport() throws InterruptedException {
					Thread.sleep(600);
					 Assert.assertTrue(traildebtorsreport.isEnabled(),"traildebtorsreport is enabled");
					 Reporter.log("verifyMyerptraildebtorsreportt", true);
					 traildebtorsreport.click();

...
public class JVRegisterVoucherNoWise{
			...
			@FindBy (xpath="//*[@id=\"tblGeneralMasters\"]/tbody/tr[6]/td[2]/a") private WebElement jvnowisereport;
			...
			// initialization
			public JVRegisterVoucherNoWise(WebDriver driver) {
				...
				public void VerifyandClickonMyerpJVNoWiseReport() throws InterruptedException {
					Thread.sleep(600);
					 Assert.assertTrue(jvnowisereport.isEnabled(),"jvnowisereport is enabled");
					 Reporter.log("verifyMyerpjvnowisereport", true);
					 jvnowisereport.click();

...
public class TrialBalanceCreditors{
			...
			@FindBy (xpath="//*[@id=\"tblGeneralMasters\"]/tbody/tr[10]/td[2]/a") private WebElement trailcreditorsreport;
			...
			// initialization
			public TrialBalanceCreditors(WebDriver driver) {
				...
				public void VerifyandClickonMyerpTrialBalanceCreditorsReport() throws InterruptedException {
					Thread.sleep(600);
					 Assert.assertTrue(trailcreditorsreport.isEnabled(),"trailcreditorsreport is enabled");
					 Reporter.log("verifyMyerptrailcreditorsreport", true);
					 trailcreditorsreport.click();

...
public class DetailLedgersReport  {
			...
			@FindBy (xpath="//*[@id=\"tblGeneralMasters\"]/tbody/tr[3]/td[2]/a") private WebElement detailledgersegister;
			@FindBy(xpath="//select[@id='ddlCompanyCode']")private WebElement selectcomp;
			@FindBy (xpath="//select[@id='ddlLedger']") private WebElement selectfromledgers;
			@FindBy (xpath="//select[@id='ddlLedger2']") private WebElement selecttoledgers;
			...
			// initialization
			public DetailLedgersReport(WebDriver driver) {
				...
				public void VerifyandClickonMyerpDetailLedgersReport() throws InterruptedException {
					Thread.sleep(600);
					 Assert.assertTrue(detailledgersegister.isEnabled(),"detailledgersegister is enabled");
					 Reporter.log("verifyMyerpdetailledgersegister", true);
					 detailledgersegister.click();
				...
				public void VerifyMyerpSelectFromLedgers() throws InterruptedException {
					Select su = new Select(selectfromledgers);
					Thread.sleep(1000);
					Assert.assertFalse(selectfromledgers.isDisplayed(),"selectfromledgers is displayed");
					Assert.assertFalse(selectfromledgers.isSelected());
					su.selectByVisibleText("MAYA 4545:400280");
				
				}
				public void VerifyMyerpSelectToLedgers() throws InterruptedException {
					Select su = new Select(selecttoledgers);
					Thread.sleep(1000);
					Assert.assertFalse(selecttoledgers.isDisplayed(),"selecttoledgers is displayed");
					Assert.assertFalse(selecttoledgers.isSelected());
					su.selectByVisibleText("MAYA 4545:400280");

...
public class TrialComparativeReport  {
			...
			@FindBy (xpath="//*[@id=\"tblGeneralMasters\"]/tbody/tr[8]/td[2]/a") private WebElement trailcomparative;
			...
			// initialization
			public TrialComparativeReport(WebDriver driver) {
				...
				public void VerifyandClickonMyerpTrialComparativeReport() throws InterruptedException {
					Thread.sleep(600);
					 Assert.assertTrue(trailcomparative.isEnabled(),"trailcomparative is enabled");
					 Reporter.log("verifyMyerptrailcomparative", true);
					 trailcomparative.click();

...
public class TrialBalanceStraightReport {
			...
			@FindBy (xpath="//*[@id=\"tblGeneralMasters\"]/tbody/tr[7]/td[2]/a") private WebElement trailbalancestraight;
			...
			// initialization
			public TrialBalanceStraightReport(WebDriver driver) {
				...
				public void VerifyandClickonMyerpTrialBalanceStraightReport() throws InterruptedException {
					Thread.sleep(600);
					 Assert.assertTrue(trailbalancestraight.isEnabled(),"trailbalancestraight is enabled");
					 Reporter.log("verifyMyerptrailbalancestraight", true);
					 trailbalancestraight.click();

...
public class ConsolidateDeliveryReport {
		@FindBy (xpath="//input[@id='txtAgencyCode']") private WebElement agancycode ;
		@FindBy (xpath="//input[@id='txtEmail']") private WebElement userid;
		@FindBy (xpath="//input[@id='password-field']") private WebElement password;
		@FindBy (xpath="//button[@id='btnLogin']") private WebElement login;
		@FindBy (xpath="//*[@id=\"menuReports\"]/a/span[1]") private WebElement genralreport;
		@FindBy (xpath="//*[@id=\"menuReports\"]/ul/li[14]/a") private WebElement consolidatedeliveryreport;
		...
		// initialization
					public ConsolidateDeliveryReport(WebDriver driver) {
						...
						public void VerifyMyerpConsolidateDeliveryReport() {
							 Assert.assertTrue(consolidatedeliveryreport.isEnabled(),"consolidatedeliveryreport field is enabled");		 
							 Reporter.log("verifyMyerpconsolidatedeliveryreport", true);
							 consolidatedeliveryreport.click(); 
						}
						...
						public void verifyMyerpSelectProduct() throws InterruptedException {
							...
							su.selectByVisibleText("5 KG COMM");

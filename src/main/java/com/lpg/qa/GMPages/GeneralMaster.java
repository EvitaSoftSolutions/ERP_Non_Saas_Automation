...
//Empty master Form
	...
	@FindBy (xpath="//button[@class='confirm']") private WebElement ebtnsubmitok;
...
//vehicle Form
	...
	@FindBy(xpath="//*[@id=\"bck\"]")private WebElement backbtn3;
...
//Commercial Party Form
	...
	@FindBy (xpath="//*[@id=\"divContentHolder\"]/form/section[2]/div/div/div/div[1]/div[9]/div/div") private WebElement cpactivechk;
...
//product rate slab
	...
	public void VerifyMyerpProductDate() throws InterruptedException {
		...
		productdate.clear();
		productdate.sendKeys("20/03/2023");
		productdate.click();
	...
	public void selectcompany() throws InterruptedException {
		...
		sc.selectByVisibleText("Anita Gas");
	}
...
//supplier	
	...
	//Employee Form
		...
		public void ESelectCompany() throws InterruptedException {
			...
			Assert.assertFalse(selectcompany.isDisplayed(),"selectcompany is displayed");
			Assert.assertFalse(selectcompany.isSelected());
			sc.selectByVisibleText("PANKAJ GAS SERVICES");
		}
...
//Transporter Form	
	...
	//Vehicle
		...
		public void verifyMyerpInsuranceToDate() throws InterruptedException {
		...
		public void VerifyMyerpBackbtn3() throws InterruptedException {
			Thread.sleep(800);
			Assert.assertTrue(backbtn3.isEnabled(),"backbtn3 field is enabled");		 
			Reporter.log("verifyMyerpbackbtn3", true);
			backbtn3.click(); 
			Thread.sleep(500);
		}
...
//commercial Party From
	...
	public void VerifyMyerpCPPincode2() throws InterruptedException {
		Thread.sleep(1000);
		Assert.assertTrue(cppincode.isEnabled(),"cppincode field is enabled");		 
		Reporter.log("verifyMyerpcppincode", true);
		cppincode.click(); 
	...
	public void VerifyMyerpCPEmailId2() throws InterruptedException {
		Thread.sleep(1000);
		Assert.assertTrue(cpemailid.isEnabled(),"cpemailid field is enabled");		 
		Reporter.log("verifyMyerpcpemailid", true);
		cpemailid.click(); 
	...
	public void VerifyMyerpCPContactDetail2() throws InterruptedException {
		Thread.sleep(1000);
		Assert.assertTrue(cpcontactdetail.isEnabled(),"cpcontactdetail field is enabled");		 
		Reporter.log("verifyMyerpcpcontactdetail", true);
		cpcontactdetail.click(); 
	...
	public void VerifyMyerpCPContactPersonName2() throws InterruptedException {
		Thread.sleep(1000);
		Assert.assertTrue(cpcontactpersonname.isEnabled(),"cpcontactpersonname field is enabled");		 
		Reporter.log("verifyMyerpcpcontactpersonname", true);
		cpcontactpersonname.click(); 
	...
	public void VerifyMyerpCPMobileNumber2() throws InterruptedException {
		Thread.sleep(1000);
		Assert.assertTrue(cpmobilenumber.isEnabled(),"cpmobilenumber field is enabled");		 
		Reporter.log("verifyMyerpcpmobilenumber", true);
		cpmobilenumber.click(); 
	...
	public void VerifyMyerpCPPincode3() throws InterruptedException {
		Thread.sleep(1000);
		Assert.assertTrue(cppincode.isEnabled(),"cppincode field is enabled");		 
		Reporter.log("verifyMyerpcppincode", true);
		cppincode.click(); 
	...
	public void VerifyMyerpCPEmailId3() throws InterruptedException {
		Thread.sleep(1000);
		Assert.assertTrue(cpemailid.isEnabled(),"cpemailid field is enabled");		 
		Reporter.log("verifyMyerpcpemailid", true);
		cpemailid.click(); 
	...
	public void VerifyMyerpCPContactDetail3() throws InterruptedException {
		Thread.sleep(1000);
		Assert.assertTrue(cpcontactdetail.isEnabled(),"cpcontactdetail field is enabled");		 
		Reporter.log("verifyMyerpcpcontactdetail", true);
		cpcontactdetail.click(); 
	...
	public void VerifyMyerpCPContactPersonName3() throws InterruptedException {
		Thread.sleep(1000);
		Assert.assertTrue(cpcontactpersonname.isEnabled(),"cpcontactpersonname field is enabled");		 
		Reporter.log("verifyMyerpcpcontactpersonname", true);
		cpcontactpersonname.click(); 
	...
	public void VerifyMyerpCPMobileNumber3() throws InterruptedException {
		Thread.sleep(1000);
		Assert.assertTrue(cpmobilenumber.isEnabled(),"cpmobilenumber field is enabled");		 
		Reporter.log("verifyMyerpcpmobilenumber", true);
		cpmobilenumber.click(); 
	...
	public void VerifyMyerpCPPincode4() throws InterruptedException {
		Thread.sleep(1000);
		Assert.assertTrue(cppincode.isEnabled(),"cppincode field is enabled");		 
		Reporter.log("verifyMyerpcppincode", true);
		cppincode.click(); 
	...
	public void VerifyMyerpCPEmailId4() throws InterruptedException {
		Thread.sleep(1000);
		Assert.assertTrue(cpemailid.isEnabled(),"cpemailid field is enabled");		 
		Reporter.log("verifyMyerpcpemailid", true);
		cpemailid.click(); 
	...
	public void VerifyMyerpCPContactDetail4() throws InterruptedException {
		Thread.sleep(1000);
		Assert.assertTrue(cpcontactdetail.isEnabled(),"cpcontactdetail field is enabled");		 
		Reporter.log("verifyMyerpcpcontactdetail", true);
		cpcontactdetail.click(); 
	...
	public void VerifyMyerpCPContactPersonName4() throws InterruptedException {
		Thread.sleep(1000);
		Assert.assertTrue(cpcontactpersonname.isEnabled(),"cpcontactpersonname field is enabled");		 
		Reporter.log("verifyMyerpcpcontactpersonname", true);
		cpcontactpersonname.click(); 
	...
	public void VerifyMyerpCPMobileNumber4() throws InterruptedException {
		Thread.sleep(1000);
		Assert.assertTrue(cpmobilenumber.isEnabled(),"cpmobilenumber field is enabled");		 
		Reporter.log("verifyMyerpcpmobilenumber", true);
		cpmobilenumber.click(); 
	...
	public void VerifyMyerpCPPincode5() throws InterruptedException {
		Thread.sleep(1000);
		Assert.assertTrue(cppincode.isEnabled(),"cppincode field is enabled");		 
		Reporter.log("verifyMyerpcppincode", true);
		cppincode.click(); 
	...
	public void VerifyMyerpCPEmailId5() throws InterruptedException {
		Thread.sleep(1000);
		Assert.assertTrue(cpemailid.isEnabled(),"cpemailid field is enabled");		 
		Reporter.log("verifyMyerpcpemailid", true);
		cpemailid.click(); 
	...
	public void VerifyMyerpCPContactDetail5() throws InterruptedException {
		Thread.sleep(1000);
		Assert.assertTrue(cpcontactdetail.isEnabled(),"cpcontactdetail field is enabled");		 
		Reporter.log("verifyMyerpcpcontactdetail", true);
		cpcontactdetail.click(); 
	...
	public void VerifyMyerpCPContactPersonName5() throws InterruptedException {
		Thread.sleep(1000);
		Assert.assertTrue(cpcontactpersonname.isEnabled(),"cpcontactpersonname field is enabled");		 
		Reporter.log("verifyMyerpcpcontactpersonname", true);
		cpcontactpersonname.click(); 
	...
	public void VerifyMyerpCPMobileNumber5() throws InterruptedException {
		Thread.sleep(1000);
		Assert.assertTrue(cpmobilenumber.isEnabled(),"cpmobilenumber field is enabled");		 
		Reporter.log("verifyMyerpcpmobilenumber", true);
		cpmobilenumber.click(); 
...
// Services Form	
	...
	public void verifyMyerpSubmit() throws InterruptedException {
		Assert.assertTrue(submitbtn.isEnabled(),"submitbtn is Enable");
	...
	public void verifyMyerpServiceDescription2() throws InterruptedException {
		Thread.sleep(500);
		Assert.assertTrue(servicedescription.isEnabled(),"servicedescription is Enable");
		Reporter.log("verifyMyerpservicedescription",true);
	...
	public void verifyMyerpServicestitle2() throws InterruptedException {
		Thread.sleep(500);
	...
	public void verifyMyerpSubmit2() throws InterruptedException {
		Assert.assertTrue(submitbtn.isEnabled(),"submitbtn is Enable");
		Reporter.log("verifyMyerpsubmitbtn",true);
		submitbtn.click();
		Thread.sleep(500);
	...
	public void verifyMyerpServiceDescription3() throws InterruptedException {
		Thread.sleep(500);
		Assert.assertTrue(servicedescription.isEnabled(),"servicedescription is Enable");
		Reporter.log("verifyMyerpservicedescription",true);
		servicedescription.clear();
	...
	public void verifyMyerpSubmit3() throws InterruptedException {
		Assert.assertTrue(submitbtn.isEnabled(),"submitbtn is Enable");
		Reporter.log("verifyMyerpsubmitbtn",true);
		submitbtn.click();
		Thread.sleep(500);
...
//Godown Transaction Form	
	...
	public void verifyMyerpGodown() throws InterruptedException {
		Thread.sleep(1000);

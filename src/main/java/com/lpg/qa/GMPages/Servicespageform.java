...
public class Servicespageform {
	...
	public void VerifyandClickonPSearchbar1() throws InterruptedException {
		...
		pcsearchbar.click(); 
		pcsearchbar.clear();
		pcsearchbar.sendKeys("STAMP DUTY");
	...
	public void VerifyandClickonPSearchbar22() throws InterruptedException {
		...
		pcsearchbar.click(); 
		pcsearchbar.clear();
		pcsearchbar.sendKeys("INSTALLATION CHARGE");
	...
	public void VerifyandClickonPSearchbar33() throws InterruptedException {
		Thread.sleep(500);
		Assert.assertTrue(pcsearchbar.isEnabled()," pcsearchbar field is enabled");
		Reporter.log(" verifyMyerp pcsearchbar", true);
		pcsearchbar.click(); 
		pcsearchbar.clear();
		pcsearchbar.sendKeys("Mechanical Service");

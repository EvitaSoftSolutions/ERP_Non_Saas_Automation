...
public class ProductRateSlab {
		...
		public void VerifyMyerpPurchaseMRP2() throws InterruptedException {
			Thread.sleep(500);
			 ...
			 Reporter.log("verifyMyerppurchasemrp", true);
			 purchasemrp.click(); 
			 purchasemrp.sendKeys("1052.5");
			 
		}
		public void VerifyMyerpPurchasDeposit2() throws InterruptedException {
			Thread.sleep(500);
			 Assert.assertTrue(purchasemrp.isEnabled(),"productdeposit field is enabled");		 
			 Reporter.log("verifyMyerproductdeposit", true);
			 productdeposit.click(); 
		...
		public void VerifyMyerpPurchaseRate3() throws InterruptedException {
			Thread.sleep(500);
			 Assert.assertTrue(purchaserate.isEnabled(),"purchaserate field is enabled");		 
			 Reporter.log("verifyMyerppurchaserate", true);
			 purchaserate.click(); 
			 purchaserate.sendKeys("190");
		}
		public void VerifyMyerpPurchaseMRP3() throws InterruptedException {
			Thread.sleep(500);
			 Assert.assertTrue(purchasemrp.isEnabled(),"purchasemrp field is enabled");		 
			 Reporter.log("verifyMyerppurchasemrp", true);
			 purchasemrp.click(); 
		...
		public void VerifyMyerpPurchaseRate4() throws InterruptedException {
			Thread.sleep(500);
			 Assert.assertTrue(purchaserate.isEnabled(),"purchaserate field is enabled");		 
			 Reporter.log("verifyMyerppurchaserate", true);
			 purchaserate.click(); 
		...
		public void VerifyMyerpPurchaseMRP4() throws InterruptedException {
			Thread.sleep(500);
			 Assert.assertTrue(purchasemrp.isEnabled(),"purchasemrp field is enabled");		 
			 Reporter.log("verifyMyerppurchasemrp", true);
			 purchasemrp.click(); 
			 purchasemrp.sendKeys("260");
		...
		public void setselectproduct5() throws InterruptedException {
			Select sp = new Select(selectproduct);
			Thread.sleep(1000);
			Assert.assertFalse(selectproduct.isDisplayed(),"selectproduct is  displayed");
			Assert.assertFalse(selectproduct.isSelected());
		...
		public void setselectarea5() throws InterruptedException {
			Select sp = new Select(selectarea);
			Thread.sleep(1000);
			Assert.assertFalse(selectarea.isDisplayed(),"selectproduct is  displayed");
			Assert.assertFalse(selectarea.isSelected());
		...
		public void VerifyMyerpPurchaseRate5() throws InterruptedException {
			Thread.sleep(500);
			 Assert.assertTrue(purchaserate.isEnabled(),"purchaserate field is enabled");		 
			 Reporter.log("verifyMyerppurchaserate", true);
			 purchaserate.click(); 
		...
		public void VerifyMyerpPurchaseMRP5() throws InterruptedException {
			Thread.sleep(500);
			 Assert.assertTrue(purchasemrp.isEnabled(),"purchasemrp field is enabled");		 
			 Reporter.log("verifyMyerppurchasemrp", true);
			 purchasemrp.click(); 
			 purchasemrp.sendKeys("60");
			 
		}
		public void VerifyMyerpPurchasDeposit5() throws InterruptedException {
			Thread.sleep(500);
			 Assert.assertTrue(purchasemrp.isEnabled(),"productdeposit field is enabled");		 
			 Reporter.log("verifyMyerproductdeposit", true);
			 productdeposit.click(); 
		...
		public void VerifyMyerpProductDate5() throws InterruptedException {
			Thread.sleep(500);
			 Assert.assertTrue(productdate.isEnabled(),"productdate field is enabled");		 
			 Reporter.log("verifyMyerproductdate", true);
			 productdate.click(); 
		...
		public void selectcompany5() throws InterruptedException {
			Select sc = new Select(selectcompany);
			Thread.sleep(1000);
			Assert.assertTrue(selectcompany.isDisplayed(),"selectcompany is displayed");
			Assert.assertFalse(selectcompany.isSelected());
		...
		public void VerifyMyerpProductActiveBtn5() throws InterruptedException {
			Thread.sleep(500);
			 Assert.assertTrue(pactivechk.isEnabled(),"pactivechk field is enabled");		 
			 Reporter.log("verifyMyerppactivechk", true);
			 pactivechk.click(); 
		...
		public void VerifyMyerpProductSubmitBtn5() throws InterruptedException {
			Thread.sleep(500);
			 Assert.assertTrue(psubmitbtn.isEnabled(),"psubmitbtn field is enabled");		 
			 Reporter.log("verifyMyerppsubmitbtn", true);
			 psubmitbtn.click(); 	 

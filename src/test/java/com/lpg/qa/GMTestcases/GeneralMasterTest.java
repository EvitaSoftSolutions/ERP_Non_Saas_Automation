...
public class GeneralMasterTest  extends LpgTestBase{
	...
	//product
		...
		pr.VerifyMyerpProductSubmitBtn1(); 
		...
		pr.setselectproduct(); 
		pr.setselectarea();
		pr.VerifyMyerpProductrate(); 
		pr.VerifyMyerpprdouctmrp();
		pr.VerifyMyerpPurchasDeposit();
		//pr.VerifyMyerpProductDate();
		//pr.selectcompany(); 
		pr.VerifyMyerpProductActiveBtn();
		pr.VerifyMyerpProductSubmitBtn();

		
		pr.setselectproduct1(); 
		pr.setselectarea1();
		pr.VerifyMyerpProductrate1(); 
		pr.VerifyMyerpprdouctmrp1();
		pr.VerifyMyerpProductDeposit1(); 
		//pr.VerifyMyerpProductDate1();
		//pr.selectcompany1(); 
		pr.VerifyMyerpProductActiveBtn1();
		pr.VerifyMyerpProductSubmitBtn1();
	...
	//	pr.VerifyMyerpEmployeeActiveCHK(); 
		...
		pr.VerifyMyerpCPPincode1();
		pr.VerifyMyerpCPEmailId1();
		pr.VerifyMyerpCPContactDetail1();
	...
	//  pr.VerifyMyerpCPActivechk2();
		...
		pr.VerifyMyerpCPPincode2();
		pr.VerifyMyerpCPEmailId2();
		pr.VerifyMyerpCPContactDetail2();
		pr.VerifyMyerpCPContactPersonName2();
		pr.VerifyMyerpCPMobileNumber2();

...
public class Godownpagetest extends LpgTestBase{
	...
	public void GodownpageTest()  throws InterruptedException{
		...
		gt.VerifyandClickonPSearchbar11();
		
		gt.verifyMyerpGodownName2();
		gt.verifyMyerpGodownAddress2();
		gt.verifyMyerpCheckActive2();
		gt.verifyMyerpSubmitBtn2();
		gt.verifyMyerpOKButton2();
		gt.VerifyandClickonPSearchbar2();
		gt.verifyMyerpEditbutton2();
		gt.verifyMyerpConfirmbutton2();
		gt.verifyMyerpGodownAddress22();
		gt.verifyMyerpUpdatebtn2();
		gt.verifyMyerpupdateokbtn2();
		gt.verifyMyerpexportbtn2();
		gt.VerifyandClickonPSearchbar22();

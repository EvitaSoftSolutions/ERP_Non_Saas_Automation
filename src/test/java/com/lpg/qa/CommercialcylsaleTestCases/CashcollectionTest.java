...
//		TestBase.driver.close();
	...
	public void CashcollectionPagetest() throws InterruptedException{
		...
		/*
		 * cc.verifyMyerpagancycode(); cc.verifyMyerpusrname();
		 * cc.verifyMyerppassword(); cc.verifyMyerploginbtn();
		 */
		cc.setup(driver);
		cc.verifyMyerpCommercialcylsale();
		 cc.verifyMyerpCashcollection(); 
		 /*cc.Deliveryman(); cc.Selectparty();
		 * cc.verifyMyerpChallanno(); cc.ModeofPayment(); cc.verifyMyerpCashAmount();

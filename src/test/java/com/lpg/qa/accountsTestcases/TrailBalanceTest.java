...
import com.lpg.qa.accountsPages.TrailBalance;



		public class TrailBalanceTest extends LpgTestBase{
			...
			@Test
			public void TrailBalancePageTest() throws InterruptedException {
				TrailBalance ddr=new TrailBalance(LpgTestBase.driver); 
				 ...
				 ddr.VerifyandClickonMyerpTrailBalanceReport();

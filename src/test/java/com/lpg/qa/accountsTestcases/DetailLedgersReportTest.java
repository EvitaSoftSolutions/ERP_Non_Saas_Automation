...
import com.lpg.qa.accountsPages.DetailLedgersReport;


		public class DetailLedgersReportTest extends LpgTestBase{
			...
			@Test
			public void   DetailLedgersReportPageTest() throws InterruptedException {
				DetailLedgersReport ddr=new DetailLedgersReport (LpgTestBase.driver); 
				 ...
				 ddr.VerifyandClickonMyerpDetailLedgersReport();
				 ddr.VerifyMyerpSelectFromLedgers();
				 ddr.VerifyMyerpSelectToLedgers();

...
import com.lpg.qa.accountsPages.DebitNoteRegister;





		public class DebitNoteRegisterTest extends LpgTestBase{
			...
			@Test
			public void   DebitNoteRegisterPageTest() throws InterruptedException {
				DebitNoteRegister ddr=new DebitNoteRegister(LpgTestBase.driver); 
				 ...
				 ddr.VerifyandClickonMyerpDebitnoteRegisterReport();

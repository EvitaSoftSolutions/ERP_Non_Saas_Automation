...
import com.lpg.qa.accountsPages.TrialComparativeReport;


		public class TrialComparativeReportTest extends LpgTestBase{
			...
			@Test
			public void   TrialComparativeReportPageTest() throws InterruptedException {
				TrialComparativeReport  ddr=new TrialComparativeReport(LpgTestBase.driver); 
				 ...
				 ddr.VerifyandClickonMyerpTrialComparativeReport();
